...
Elm.Eqdash = Elm.Eqdash || {};
Elm.Eqdash.make = function (_elm) {
   "use strict";
   _elm.Eqdash = _elm.Eqdash || {};
   if (_elm.Eqdash.values) return _elm.Eqdash.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var eventList = Elm.Native.Port.make(_elm).inboundSignal("eventList",
   "Eqdash.Model",
   function (v) {
      return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
         return typeof v === "object" && "title" in v && "time" in v && "magnitude" in v && "location" in v && "id" in v ? {_: {}
                                                                                                                           ,title: typeof v.title === "string" || typeof v.title === "object" && v.title instanceof String ? v.title : _U.badPort("a string",
                                                                                                                           v.title)
                                                                                                                           ,time: typeof v.time === "string" || typeof v.time === "object" && v.time instanceof String ? v.time : _U.badPort("a string",
                                                                                                                           v.time)
                                                                                                                           ,magnitude: typeof v.magnitude === "string" || typeof v.magnitude === "object" && v.magnitude instanceof String ? v.magnitude : _U.badPort("a string",
                                                                                                                           v.magnitude)
                                                                                                                           ,location: typeof v.location === "object" && "latitude" in v.location && "longitude" in v.location ? {_: {}
                                                                                                                                                                                                                                ,latitude: typeof v.location.latitude === "string" || typeof v.location.latitude === "object" && v.location.latitude instanceof String ? v.location.latitude : _U.badPort("a string",
                                                                                                                                                                                                                                v.location.latitude)
                                                                                                                                                                                                                                ,longitude: typeof v.location.longitude === "string" || typeof v.location.longitude === "object" && v.location.longitude instanceof String ? v.location.longitude : _U.badPort("a string",
                                                                                                                                                                                                                                v.location.longitude)} : _U.badPort("an object with fields `latitude`, `longitude`",
                                                                                                                           v.location)
                                                                                                                           ,id: typeof v.id === "string" || typeof v.id === "object" && v.id instanceof String ? v.id : _U.badPort("a string",
                                                                                                                           v.id)} : _U.badPort("an object with fields `title`, `time`, `magnitude`, `location`, `id`",
         v);
   ...
   var incomingEvents = A2($Signal.map,SetEvents,eventList);
   var init = {ctor: "_Tuple2",_0: _U.list([]),_1: $Effects.none};
   var Event = F5(function (a,b,c,d,e) {
      return {title: a,time: b,magnitude: c,location: d,id: e};
   });
   var LatLng = F2(function (a,b) {
      return {latitude: a,longitude: b};
   });
   var app = $StartApp.start({init: init
                             ,update: update
                             ,view: view
                             ,inputs: _U.list([incomingEvents])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",
   app.tasks);
   return _elm.Eqdash.values = {_op: _op
                               ,app: app
                               ,main: main
                               ,LatLng: LatLng
                               ,Event: Event
